...
+--------------------------------------------+-----------------------------------------------------------------------------+--------------------------------+----------------------+-------------+
| Querying Permission Rules of a File System | GET /v1/{project_id}/sfs-turbo/shares/{share_id}/fs/perm-rules              | sfsturbo:shares:listPermRules  | ``-``                | Y           |
+--------------------------------------------+-----------------------------------------------------------------------------+--------------------------------+----------------------+-------------+
...
|                        |                                       |                          |                      | (Project)   |
+========================+=======================================+==========================+======================+=============+
| Querying Tenant Quotas | GET /v1/{project_id}/sfs-turbo/quotas | sfsturbo:shares:getQuota | ``-``                | Y           |
+------------------------+---------------------------------------+--------------------------+----------------------+-------------+
