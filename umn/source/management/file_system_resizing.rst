...
#. Enter a new capacity and click **OK**. The following tables describe the parameters.
   ...
   .. table:: **Table 2** SFS Turbo file system capacity expansion parameters
      ...
      |                                   | Value constraints:                                                                                                                                                                                                                                                                                    |
      |                                   |                                                                                                                                                                                                                                                                                                       |
      |                                   | -  For a Standard, Standard - Enhanced, Performance, or Performance - Enhanced file system, the expansion increment is 100 GB. A Standard or Performance file system can be expanded to up to 32 TB, and a Standard - Enhanced or Performance - Enhanced file system can be expanded to up to 320 TB. |
